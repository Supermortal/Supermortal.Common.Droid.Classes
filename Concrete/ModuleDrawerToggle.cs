...
{
    public class ModuleDrawerToggle : SupportActionBarDrawerToggle
    {
        private AppCompatActivity _activity;
        private int _openedResource;
        private int _closedResource;

        public ModuleDrawerToggle(AppCompatActivity host, DrawerLayout drawerLayout, int openedResource, int closedResource)
